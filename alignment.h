...
public:
    ...
    void modifyPatternFreq(Alignment & aln, unsigned short * new_pattern_freqs, int new_npt); // Diep added
    ...
    int buildPattern(StrVector &sequences, char *sequence_type, int nseq, int nsite, SeqType _seq_type = SEQ_UNKNOWN);
